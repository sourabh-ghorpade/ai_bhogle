...
describe 'Match Simulation' do
  context 'the match is won' do
    it 'runs the match simulation and returns a win result' do
      ...
      expected_result = ['Lengaburu won by 4 wickets and 0 balls remaining', 'Virat Kohli- 6 (6 balls)', 'MS Dhoni- 6 (6 balls)', 'Irfan Khan- 0 (0 balls)', 'Bumrah- 0 (0 balls)', '2 overs left. 12 runs to win', '1.1 Virat Kohli scores 1 runs', '1.2 Virat Kohli scores 1 runs', '1.3 Virat Kohli scores 1 runs', '1.4 Virat Kohli scores 1 runs', '1.5 Virat Kohli scores 1 runs', '1.6 Virat Kohli scores 1 runs', '1 overs left. 6 runs to win', '2.1 MS Dhoni scores 1 runs', '2.2 MS Dhoni scores 1 runs', '2.3 MS Dhoni scores 1 runs', '2.4 MS Dhoni scores 1 runs', '2.5 MS Dhoni scores 1 runs', '2.6 MS Dhoni scores 1 runs']
  ...
  context 'the match is lost' do
    context 'batting team cannot plays out the entire overs' do
      it 'runs the match simulation and returns a loss result' do
        ...
        yet_to_play_batsmen = [Batsman.new('Irfan Khan', irfan_shot_probabilities), Batsman.new('Bumrah', bumrah_probabilities)]
        batting_team = Team.new(team_name, striker, non_striker, yet_to_play_batsmen, [])
        expected_result = ['Lengaburu lost by 2 runs', 'Virat Kohli- 6 (6 balls)', 'MS Dhoni- 6 (6 balls)', 'Irfan Khan- 0 (0 balls)', 'Bumrah- 0 (0 balls)', '2 overs left. 14 runs to win', '1.1 Virat Kohli scores 1 runs', '1.2 Virat Kohli scores 1 runs', '1.3 Virat Kohli scores 1 runs', '1.4 Virat Kohli scores 1 runs', '1.5 Virat Kohli scores 1 runs', '1.6 Virat Kohli scores 1 runs', '1 overs left. 8 runs to win', '2.1 MS Dhoni scores 1 runs', '2.2 MS Dhoni scores 1 runs', '2.3 MS Dhoni scores 1 runs', '2.4 MS Dhoni scores 1 runs', '2.5 MS Dhoni scores 1 runs', '2.6 MS Dhoni scores 1 runs']
    ...
    context 'batting team does not play out the entire overs' do
      it 'runs the match simulation and returns a loss result' do
        ...
        expected_result = ['Lengaburu lost by 14 runs', 'Virat Kohli- 0 (1 balls)', 'Irfan Khan- 0 (1 balls)', 'Bumrah- 0 (1 balls)', 'MS Dhoni- 0 (0 balls)', '2 overs left. 14 runs to win', '1.1 Virat Kohli gets out!', '1.2 Irfan Khan gets out!', '1.3 Bumrah gets out!']
